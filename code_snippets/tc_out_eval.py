...
origin_path = Path("results/20241014-gpt-tc_output-pred-func-bpt/results_merged_1.json")

target_paths = [
    Path("results/20241014-gpt-tc_output-none/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-code/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-lbl/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-func/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-nl/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-code-bpt/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-lbl-bpt/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-func-bpt/results_merged_1.json"),
    Path("results/20241014-gpt-tc_output-pred-nl-bpt/results_merged_1.json"),
]
